    ...
    function t(t) {
        return {
            ...
            link: function(e, i, n) {
                ...
                var o = new Date,
                    s = o.getHours();
                e.inputEpochTime = e.inputObj.inputEpochTime ? e.inputObj.inputEpochTime : 60 * s * 60, e.step = e.inputObj.step ? e.inputObj.step : 15, e.format = e.inputObj.format ? e.inputObj.format : 24, e.titleLabel = e.inputObj.titleLabel ? e.inputObj.titleLabel : "Time Picker", e.setLabel = e.inputObj.setLabel ? e.inputObj.setLabel : "Set", e.closeLabel = e.inputObj.closeLabel ? e.inputObj.closeLabel : "Close", e.setButtonType = e.inputObj.setButtonType ? e.inputObj.setButtonType : "button-positive", e.closeButtonType = e.inputObj.closeButtonType ? e.inputObj.closeButtonType : "button-stable", e.maxTime = e.inputObj.maxTime;
                var u = {
                ...
                var startTime = m.getUTCHours();
                var minTime = s;
                //console.log("minTime : " + minTime);
                var firstIncrementation = true;
                var currentTime;
                e.increaseHours = function () {
                  e.time.hours = Number(e.time.hours);
                  ...
                  if (u.format == 24) {
                    if (firstIncrementation ){
                        if(e.time.hours > e.maxTime){
                            e.maxTime = e.maxTime + 24;
                        }
                        firstIncrementation = false;
                        currentTime = e.time.hours;
                    }
                    if (e.time.hours < 23) {
                      console.log("currentTime : " + (currentTime).toString());
                      console.log("maxTime : " + e.maxTime);
                      if(currentTime < (e.maxTime)){
                        e.time.hours += 1;
                        currentTime++;
                        startTime ++
                        // startTime++;
                  ...
                  e.time.hours = (e.time.hours < 10) ? ('0' + e.time.hours) : e.time.hours;
                  ...
                  e.time.hours = (e.time.hours < 10) ? ('0' + e.time.hours) : e.time.hours;
                    ...
                    e.inputObj.inputEpochTime && (m = new Date(1e3 * e.inputObj.inputEpochTime)), 12 == u.format ? (e.time.meridian = m.getUTCHours() >= 12 ? "PM" : "AM", e.time.hours = m.getUTCHours() > 12 ? m.getUTCHours() - 12 : m.getUTCHours(), e.time.minutes = m.getUTCMinutes(), e.time.hours = e.time.hours < 10 ? "0" + e.time.hours : e.time.hours, e.time.minutes = e.time.minutes < 10 ? "0" + e.time.minutes : e.time.minutes, 0 == e.time.hours && "AM" == e.time.meridian && (e.time.hours = 12),
                        t.show({
                    ...
                    })) : 24 == u.format && (e.time.hours = startTime, e.time.minutes = m.getUTCMinutes(), e.time.hours = e.time.hours < 10 ? "0" + e.time.hours : e.time.hours, e.time.minutes = e.time.minutes < 10 ? "0" + e.time.minutes : e.time.minutes,
                        t.show({
                        templateUrl: "ionic-timepicker-24-hour.html",
                        title: e.titleLabel,
                        subTitle: e.inputObj.subTitleLabel,
                        scope: e,
                        buttons: [{
                            text: e.closeLabel,
                            type: e.closeButtonType,
